                ...
                <div className="modal__content_participant">
                    ...
                    <div id='radioP'>
                      <div className="radioParticipant" >
                        <input label="Add Participants" type="radio" id="add" name="participant" value="Add" onChange={() => {setComponent(<AddParticipant groupId={props.groupId} friendsArray={[1,2]}/>)}} />
                        <input label="See Participants" type="radio" id="see" name="participant" value="See" onChange={() => {setComponent(<SeeParticipant groupId={props.groupId} friendsArray={[1,2]} owner={propTypes.owner}  />)}} />
                      </div>
                    </div>
                    {component}
                </div>
